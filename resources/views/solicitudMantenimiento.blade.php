    ...
    <form action="{{route('insertMantenimiento')}}" method="GET">
        ...
        <div id="wizard">
            ...
            <section>
                ...
                <div class="form-row"> 
                    <input type="text" class="form-control" name="tip_solicitud">
                 </div>
                <label for="exampleFormControlSelect12">Area de solicitud</label>
                <div class="form-row"> <input type="text" class="form-control" name="area"> </div>
                <label for="exampleFormControlSelect12">Motivo de solicitud</label>
                <div class="form-row" style="margin-bottom: 18px"> <textarea name="motivo" id="" class="form-control" style="height: 108px"></textarea> </div>
                <div class="form-row">
                    <div class="form-group">
                      <label for="exampleFormControlSelect12">Numero de equipo</label>
                      <select class="form-control selectpicker" data-live-search="true" id="cod_persona" name="cod_equipo" value="{{old('cod_persona')}}">
            ...
            <h4></h4>
            <div class="row">
                <button type="submit" class="btn btn-info">Agregar solicitud</button>
              </div>  
            <h4></h4>
        </div>
    </form>
